 ...
 *
 * The KtT authentication strategy authenticates requests by delegating to
 * id.kreativitaet-trifft-technik.de using the OpenID 2.0 protocol.
 *
 ...
 *
 * Options:
 *   - `returnURL`  URL to which KtT will redirect the user after authentication
...
function Strategy(options, validate) {
  options = options || {};
  options.providerURL = options.providerURL || 'https://id.kreativitaet-trifft-technik.de/openidserver/op';
